...
| Cambiar **voz / wake / STT / TTS** | `src/baxy_mind/asr_fusion.py`, `phonetic_es.py`, `scripts/setup_mind_voice.ps1` | `documentacion/01_ARQUITECTURA/GUIA_AGENTES_IA/07_LATENCIA_END_TO_END.md` |
