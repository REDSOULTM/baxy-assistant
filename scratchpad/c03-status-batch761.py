...
PROFILE = PRIVATE.parent / 'C03-status-profile761'
...
prereg = {
    'utc': utc(), 'method': 'Registered73 product regression after semantic inventory760; same panel and criteria as752B, no model comparison.',
    ...
    'validation': 'Published760 owner tests, current integrity and Fast; Full7 is historical, not new product acceptance.',
