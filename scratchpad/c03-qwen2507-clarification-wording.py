...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen2507-clarification-wording'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen2507-clarification-wording.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen2507-clarification-wording/profile/sitecustomize.py',
         'scratchpad/c03-qwen2507-clarification-wording.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'Keep a valid clarify decision with zero effects when only its prose is invalid, reword through existing clarification recovery instead of redeciding intent. ES/EN missing-target requests followed by cancellation and normal turn. No segmentation override.',
          'expected': 'Useful clarification, truthful cancellation, and normal next reply in both sessions; no effect from a missing target; no stale startup welcome.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen2507-clarification-wording'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen2507-clarification-wording.turns.jsonl')]
