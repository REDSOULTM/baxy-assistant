"""Verify all sealed package identity/enumeration tranche bytes."""
...
source=source[:start]+"names=['package-identity635','package-source636','package-product637','enumeration-source638','enumeration-product639','window-reference-product640']\n"+source[end:]
