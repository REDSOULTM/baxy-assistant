"""Validate the622–627 tranche using the existing byte-preserving publication audit."""
...
source=source[:start]+"names=['ministral622','ministral-roles623','ministral-layers624','progress-language625','progress-source626','conversation-regression627']\n"+source[end:]
