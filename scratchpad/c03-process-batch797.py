...
OUT = ROOT / 'artifacts/comprobaciones/C03/PROCESS_BATCH797'
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-process-batch797-private'
PROFILE = PRIVATE.parent / 'C03-process-profile797'
...
prereg = {
    'utc': utc(), 'method': 'Registered50 process-read category with sealed candidate796; nine historical requests and41 variants. Build prepared before sealing DLL; model selection is closed.',
