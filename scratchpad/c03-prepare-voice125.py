...
out = root / 'artifacts/comprobaciones/C03/astra-voice125'
out.mkdir(exist_ok=False)
capture = (root / 'scratchpad/c03-capture-audio121.py').read_text(encoding='utf-8')
capture = capture.replace('astra-audio121', 'astra-voice125').replace('C03-audio121-private', 'C03-voice125-private')
with (root / 'scratchpad/c03-capture-voice125.py').open('x', encoding='utf-8', newline='\n') as f:
    f.write(capture)
def sha(path):
...
print('Physical isolation125 prepared, no recording or playback yet.')
