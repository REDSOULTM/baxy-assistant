...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen2507-mixed-advisory'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen2507-mixed-advisory.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen2507-mixed-advisory/profile/sitecustomize.py',
         'scratchpad/c03-qwen2507-mixed-advisory.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'Measure publication without the positive bilingual vocabulary veto. Original product prompts and all factual, authority, echo and structural checks retained; log every would-be language veto. Human adjudication remains strict and independent of publication count.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen2507-mixed-advisory'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen2507-mixed-advisory.turns.jsonl')]
