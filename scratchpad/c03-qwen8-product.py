...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen8-product'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen8-product.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen8-product/profile/sitecustomize.py',
         'scratchpad/c03-qwen8-product.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'The best inherited composition model may also improve complete-question routing and mixed prose in the real product.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen8-product'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen8-product.turns.jsonl')]
