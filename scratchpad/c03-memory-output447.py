...
assert len(cases)==11
out=base/'astra-memory-output447';private=local/'C03-memory-output447-private'
...
try:
    ...
    for case in cases:
        for variant in ['baseline','message-schema']:
