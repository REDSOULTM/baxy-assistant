...
out=base/'astra-memory-result-scope442';private=local/'C03-memory-result-scope442-private'
...
try:
    ...
    for case in cases:
        for variant in ['baseline','result-scope']:
