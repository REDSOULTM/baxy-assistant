...
OUT = ROOT / "artifacts/comprobaciones/C03/astra-replay228"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-replay228-private"
...
save(OUT / "PREREG.json", {
    ...
    "hypothesis": "After source228 also waits for three eligible consecutive frames before opening a turn during TTS, replay every exact221 frame and report all segments/decisions. Do not change thresholds or filter recognized text. Compare to baseline222.",
...
np.savez(PRIVATE / "segments228.npz", **signals)
