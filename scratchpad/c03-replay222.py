...
OUT = ROOT / "artifacts/comprobaciones/C03/astra-replay222"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-replay222-private"
...
save(OUT / "PREREG.json", {
    ...
    "hypothesis": "VAD-positive echo below the existing barge energy threshold is still accepted by segmentation because speech remains true in that branch. Establish exact first segment and speech/energy evidence before editing.",
...
np.savez(PRIVATE / "segments222.npz", **signals)
