...
out = root / 'artifacts/comprobaciones/C03/astra-native-generalization386'
private = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-native-generalization386-private'
...
hook = private / 'hook'
hook.mkdir()
hook_source = (root / 'scratchpad/c03-owner370-hook/sitecustomize.py').read_text(encoding='utf-8').replace('C03-memory-product370-private', 'C03-native-generalization386-private')
...
try:
    ...
    configure = {'id': 'catalog386', 'type': 'catalog.configure', 'capabilities': capabilities}
