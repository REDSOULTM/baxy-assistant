...
sys.path[:0]=['D:/BAXYRuntime/experiments/voice/dtln179/python',str(root/'src')]
sys.stdout.reconfigure(encoding='utf-8')
from ai_edge_litert.interpreter import Interpreter
from baxy_mind.voice import SileroVad
privbase=Path(os.environ['LOCALAPPDATA'])/'BAXY'
private=privbase/'C03-dtln180-private'
...
for name,mic,ref in cases:
    ...
    interpreters=[Interpreter(model_path=str(folder/f'dtln_aec_512_{i}.tflite'),num_threads=1) for i in [1,2]]
    ...
    path=private/f'{name}-dtln512.wav'
