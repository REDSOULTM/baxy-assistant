...
out=base/'astra-audio-mind505-baseline';private=local/'C03-audio-mind505-baseline-private'
...
try:
 ...
 config_req={'id':'catalog505-baseline','type':'catalog.configure','capabilities':capabilities}
 ...
 stop.set();client.close(graceful_message={'id':'close505-baseline','type':'shutdown'},timeout=15);guard.join(timeout=5);gpu.stop();ram.stop()
