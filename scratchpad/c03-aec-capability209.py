...
OUT = ROOT / "artifacts/comprobaciones/C03/astra-aec-capability209"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-aec-capability209-private"
OUT.mkdir(exist_ok=False)
PRIVATE.mkdir(exist_ok=False)
source = ROOT / "scratchpad/c03-aec-capability209.cpp"
def digest(path):
...
save(OUT / "PREREG.json", {
    ...
    "purpose": "Query Windows AEC services for default capture endpoints before considering integration",
    "roles": ["console", "multimedia", "communications"],
    "categories": ["other", "communications"],
    "audioStarted": False, "recording": False, "globalSettingsChanged": False,
...
exe = PRIVATE / "probe209.exe"
build.write_text(
    '@echo off\ncall "C:\\Program Files (x86)\\Microsoft Visual Studio\\2022\\BuildTools\\VC\\Auxiliary\\Build\\vcvars64.bat" >nul\n'
    f'cl /nologo /std:c++17 /EHsc /W4 /D_WIN32_WINNT=0x0A00 "{source}" /Fe:"{exe}" /Fo:"{PRIVATE / "probe209.obj"}" /link ole32.lib uuid.lib\n'
    'exit /b %errorlevel%\n', encoding="utf-8")
