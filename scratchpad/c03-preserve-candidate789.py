"""Preserve measured789 before any further repair; do not adopt it."""
...
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-inventory-source789-private'
...
assert head == '64b493889d030133be42461d467cde85def856c3'
patch = []
...
record = {'utc': datetime.now(timezone.utc).isoformat(), 'candidate_adopted': False,
          ...
          'reverse_patch_check_exit': 0, 'reason': '790 blocks incomplete lists but does not recover them. Review found final-title sentence counting and process annotation ambiguities; preserve candidate before further repair.'}
