...
with urllib.request.urlopen('http://127.0.0.1:55515/slots',timeout=5) as response:
...
snapshot=private.parent/'C03-ui313-snapshot314'
...
out=root/'artifacts/comprobaciones/C03/astra-selector314'
(out/'STOP313.json').write_text(json.dumps({'snapshot':str(snapshot),'owned':owned},indent=2)+'\n',encoding='utf-8')
print('UI313 had no owner turns; logs preserved; verified owned tree stopped for integrated314.')
