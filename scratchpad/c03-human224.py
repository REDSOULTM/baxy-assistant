...
OUT = BASE / "astra-human224"
PRIVATE_ROOT = Path(os.environ["LOCALAPPDATA"]) / "BAXY"
PRIVATE = PRIVATE_ROOT / "C03-human224-private"
...
spec = importlib.util.spec_from_file_location("baxy_mind.voice_baseline224", baseline_path)
...
for row in inputs:
    ...
    variants = []
    for name, module in [("before220", baseline), ("after223", current)]:
