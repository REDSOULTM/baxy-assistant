...
out = root / 'artifacts/comprobaciones/C03/astra-language-mind398'
private = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-language-mind398-private'
...
cases_path = root / 'scratchpad/c03-language-mind398-cases.json'
...
try:
    ...
    configure = {'id': 'catalog398', 'type': 'catalog.configure', 'capabilities': capabilities}
    ...
    client.close(graceful_message={'id': 'close398', 'type': 'shutdown'}, timeout=15)
