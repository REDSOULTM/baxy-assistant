...
out=base/'astra-audio-mind508';private=local/'C03-audio-mind508-private'
...
cases=[{'id': 'definition-es-registered-0', 'request': '¿Qué significa desmutear?', 'history': [], 'expected': [], 'case_id': 'definition-es', 'profile': {'name': 'registered', 'seed': 0, 'sampling': {'seed': 0}}}, {'id': 'definition-en-registered-0', 'request': 'What does unmute mean?', 'history': [], 'expected': [], 'case_id': 'definition-en', 'profile': {'name': 'registered', 'seed': 0, 'sampling': {'seed': 0}}}, {'id': 'ram-new-topic-registered-0', 'request': 'Explain what RAM is.', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Hello Jordan.'}], 'expected': [], 'case_id': 'ram-new-topic', 'profile': {'name': 'registered', 'seed': 0, 'sampling': {'seed': 0}}}, {'id': 'name-es-registered-0', 'request': 'Me llamo Álvaro. ¿Cuál es mi nombre?', 'history': [], 'expected': [], 'case_id': 'name-es', 'profile': {'name': 'registered', 'seed': 0, 'sampling': {'seed': 0}}}, {'id': 'name-en-registered-0', 'request': 'My name is Jordan. What is my name?', 'history': [], 'expected': [], 'case_id': 'name-en', 'profile': {'name': 'registered', 'seed': 0, 'sampling': {'seed': 0}}}, {'id': 'recall-es-registered-0', 'request': '¿Cómo me llamo?', 'history': [{'role': 'user', 'content': 'Me llamo Álvaro.'}], 'expected': [], 'case_id': 'recall-es', 'profile': {'name': 'registered', 'seed': 0, 'sampling': {'seed': 0}}}, {'id': 'recall-en-registered-0', 'request': 'What is my name?', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Your name is Morgan.'}], 'expected': [], 'case_id': 'recall-en', 'profile': {'name': 'registered', 'seed': 0, 'sampling': {'seed': 0}}}, {'id': 'definition-es-qwen_documented-0', 'request': '¿Qué significa desmutear?', 'history': [], 'expected': [], 'case_id': 'definition-es', 'profile': {'name': 'qwen_documented', 'seed': 0, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 0}}}, {'id': 'definition-en-qwen_documented-0', 'request': 'What does unmute mean?', 'history': [], 'expected': [], 'case_id': 'definition-en', 'profile': {'name': 'qwen_documented', 'seed': 0, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 0}}}, {'id': 'ram-new-topic-qwen_documented-0', 'request': 'Explain what RAM is.', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Hello Jordan.'}], 'expected': [], 'case_id': 'ram-new-topic', 'profile': {'name': 'qwen_documented', 'seed': 0, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 0}}}, {'id': 'name-es-qwen_documented-0', 'request': 'Me llamo Álvaro. ¿Cuál es mi nombre?', 'history': [], 'expected': [], 'case_id': 'name-es', 'profile': {'name': 'qwen_documented', 'seed': 0, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 0}}}, {'id': 'name-en-qwen_documented-0', 'request': 'My name is Jordan. What is my name?', 'history': [], 'expected': [], 'case_id': 'name-en', 'profile': {'name': 'qwen_documented', 'seed': 0, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 0}}}, {'id': 'recall-es-qwen_documented-0', 'request': '¿Cómo me llamo?', 'history': [{'role': 'user', 'content': 'Me llamo Álvaro.'}], 'expected': [], 'case_id': 'recall-es', 'profile': {'name': 'qwen_documented', 'seed': 0, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 0}}}, {'id': 'recall-en-qwen_documented-0', 'request': 'What is my name?', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Your name is Morgan.'}], 'expected': [], 'case_id': 'recall-en', 'profile': {'name': 'qwen_documented', 'seed': 0, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 0}}}, {'id': 'definition-es-registered-17', 'request': '¿Qué significa desmutear?', 'history': [], 'expected': [], 'case_id': 'definition-es', 'profile': {'name': 'registered', 'seed': 17, 'sampling': {'seed': 17}}}, {'id': 'definition-en-registered-17', 'request': 'What does unmute mean?', 'history': [], 'expected': [], 'case_id': 'definition-en', 'profile': {'name': 'registered', 'seed': 17, 'sampling': {'seed': 17}}}, {'id': 'ram-new-topic-registered-17', 'request': 'Explain what RAM is.', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Hello Jordan.'}], 'expected': [], 'case_id': 'ram-new-topic', 'profile': {'name': 'registered', 'seed': 17, 'sampling': {'seed': 17}}}, {'id': 'name-es-registered-17', 'request': 'Me llamo Álvaro. ¿Cuál es mi nombre?', 'history': [], 'expected': [], 'case_id': 'name-es', 'profile': {'name': 'registered', 'seed': 17, 'sampling': {'seed': 17}}}, {'id': 'name-en-registered-17', 'request': 'My name is Jordan. What is my name?', 'history': [], 'expected': [], 'case_id': 'name-en', 'profile': {'name': 'registered', 'seed': 17, 'sampling': {'seed': 17}}}, {'id': 'recall-es-registered-17', 'request': '¿Cómo me llamo?', 'history': [{'role': 'user', 'content': 'Me llamo Álvaro.'}], 'expected': [], 'case_id': 'recall-es', 'profile': {'name': 'registered', 'seed': 17, 'sampling': {'seed': 17}}}, {'id': 'recall-en-registered-17', 'request': 'What is my name?', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Your name is Morgan.'}], 'expected': [], 'case_id': 'recall-en', 'profile': {'name': 'registered', 'seed': 17, 'sampling': {'seed': 17}}}, {'id': 'definition-es-qwen_documented-17', 'request': '¿Qué significa desmutear?', 'history': [], 'expected': [], 'case_id': 'definition-es', 'profile': {'name': 'qwen_documented', 'seed': 17, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 17}}}, {'id': 'definition-en-qwen_documented-17', 'request': 'What does unmute mean?', 'history': [], 'expected': [], 'case_id': 'definition-en', 'profile': {'name': 'qwen_documented', 'seed': 17, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 17}}}, {'id': 'ram-new-topic-qwen_documented-17', 'request': 'Explain what RAM is.', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Hello Jordan.'}], 'expected': [], 'case_id': 'ram-new-topic', 'profile': {'name': 'qwen_documented', 'seed': 17, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 17}}}, {'id': 'name-es-qwen_documented-17', 'request': 'Me llamo Álvaro. ¿Cuál es mi nombre?', 'history': [], 'expected': [], 'case_id': 'name-es', 'profile': {'name': 'qwen_documented', 'seed': 17, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 17}}}, {'id': 'name-en-qwen_documented-17', 'request': 'My name is Jordan. What is my name?', 'history': [], 'expected': [], 'case_id': 'name-en', 'profile': {'name': 'qwen_documented', 'seed': 17, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 17}}}, {'id': 'recall-es-qwen_documented-17', 'request': '¿Cómo me llamo?', 'history': [{'role': 'user', 'content': 'Me llamo Álvaro.'}], 'expected': [], 'case_id': 'recall-es', 'profile': {'name': 'qwen_documented', 'seed': 17, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 17}}}, {'id': 'recall-en-qwen_documented-17', 'request': 'What is my name?', 'history': [{'role': 'user', 'content': 'My name is Jordan.'}, {'role': 'assistant', 'content': 'Your name is Morgan.'}], 'expected': [], 'case_id': 'recall-en', 'profile': {'name': 'qwen_documented', 'seed': 17, 'sampling': {'temperature': 0.7, 'top_p': 0.8, 'top_k': 20, 'min_p': 0.0, 'presence_penalty': 0.0, 'repeat_penalty': 1.0, 'seed': 17}}}]
...
write(out/'PREREG.json',{'utc':datetime.now(timezone.utc).isoformat(),'method':'508: see astra-chat-profile508/PREREG.json for the exact28cases and paired chat-only sampling. No effects or model promotion.','profile_reason':'Current registered runtime baseline for source regression, not a model-capability ranking or claim that defaults are optimal. Model-specific profile research448-484 remains; a bad result here is inspected at its first boundary, not a new default-based model rejection.','cases':cases,'criteria':'Factual natural conversation and correct fact speaker across two seeds; actual HTTP profile coverage/EOS/resources required. No reserve, physical or acceptance credit.','model':config['gguf'],'model_sha256':sha(config['gguf']),'server':config['llama_server'],'server_sha256':sha(config['llama_server']),'manifest_sha256':sha(manifest),'core':str(core),'core_sha256':sha(core),'source_sha256':{str(p):sha(p) for p in [root/'src/baxy_mind/effect_intent.py',root/'src/baxy_mind/llm.py',root/'src/baxy_mind/__main__.py']},'private':str(private),'limits':{'gpu_stop_mib':3800,'minimum_free_ram_mib':768,'request_seconds':90}})
hook=private/'hook';hook.mkdir()
hook_source=(root/'scratchpad/c03-owner370-hook/sitecustomize.py').read_text(encoding='utf-8-sig').replace('C03-memory-product370-private','C03-audio-mind508-private')
hook_source+=(root/'scratchpad/c03-observe407-hook.py').read_text(encoding='utf-8-sig').replace("Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-retrieval-startup407-private/startup-observer.jsonl'","Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-audio-mind508-private/startup.jsonl'")
...
try:
 ...
 config_req={'id':'catalog508','type':'catalog.configure','capabilities':capabilities}
 ...
 stop.set();client.close(graceful_message={'id':'close508','type':'shutdown'},timeout=15);guard.join(timeout=5);gpu.stop();ram.stop()
