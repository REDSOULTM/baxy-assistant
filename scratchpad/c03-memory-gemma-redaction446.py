...
assert len(cases)==11
out=base/'astra-memory-gemma-redaction446';private=local/'C03-memory-gemma-redaction446-private'
...
try:
    ...
    for case in cases:
        initial=json.loads(fact_line(case['payload']).removeprefix('situation: '))
