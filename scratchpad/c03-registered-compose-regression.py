...
OUT=ROOT/'artifacts/comprobaciones/C03/astra-registered-compose-regression'
...
try:
    ...
    for case in cases:
        ...
        try:answer=client.compose_user_message(case['request'],case['intent'],{'situation':json.dumps(case['situation'],ensure_ascii=False)})
