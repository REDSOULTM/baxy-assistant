...
out=base/'astra-audio-mind507';private=local/'C03-audio-mind507-private'
...
try:
 ...
 config_req={'id':'catalog507','type':'catalog.configure','capabilities':capabilities}
 ...
 stop.set();client.close(graceful_message={'id':'close507','type':'shutdown'},timeout=15);guard.join(timeout=5);gpu.stop();ram.stop()
