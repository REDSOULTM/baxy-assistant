...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen8-iq3-product'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen8-iq3-product.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen8-iq3-product/profile/sitecustomize.py',
         'scratchpad/c03-qwen8-iq3-product.py']
...
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          ...
          'profile': {'model': str(model), 'sha256': sha(model), 'ngl': 30,
...
env = os.environ.copy()
env.update(BAXY_MIND_LLM_GGUF=str(model), BAXY_MIND_NGL='30', BAXY_MIND_KV_CACHE_TYPE='q4_0',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen8-iq3-product'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen8-iq3-product.turns.jsonl')]
