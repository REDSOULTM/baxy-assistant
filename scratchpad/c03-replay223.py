...
OUT = ROOT / "artifacts/comprobaciones/C03/astra-replay223"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-replay223-private"
...
save(OUT / "PREREG.json", {
    ...
    "hypothesis": "After source223 sets speech=False in the existing energy rejection branch, replay every exact221 frame and report all segments/decisions. Do not change thresholds or filter recognized text. Compare to baseline222.",
...
np.savez(PRIVATE / "segments223.npz", **signals)
