...
private=privbase/'C03-gain178-private'
...
save(out/'BUILD.json',{'wheel':str(wheel),'sha256':hashlib.sha256(wheel.read_bytes()).hexdigest(),'bytes':wheel.stat().st_size,'source':'Experimental default echo-path gain0.1; same static library176; not deployed','runtime':sys.executable})
