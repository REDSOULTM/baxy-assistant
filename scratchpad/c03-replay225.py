...
OUT = ROOT / "artifacts/comprobaciones/C03/astra-replay225"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-replay225-private"
...
save(OUT / "PREREG.json", {
    ...
    "hypothesis": "After source225 sets speech=speech_started in the existing energy rejection branch, replay every exact221 frame and report all segments/decisions. Do not change thresholds or filter recognized text. Compare to baseline222.",
...
np.savez(PRIVATE / "segments225.npz", **signals)
