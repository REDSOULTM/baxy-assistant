...
out=local/'C03-private-exposure483-private'
public=root/'artifacts/comprobaciones/C03/astra-private-exposure483'
...
prior=local/'C03-exposure470-private/review.jsonl'
...
with (out/'review.jsonl').open('x',encoding='utf-8') as f:
 for row in rows:
  refs=sorted(matches.get(row['id'],[]));row['private_development_exposure483']=refs
  if refs:
