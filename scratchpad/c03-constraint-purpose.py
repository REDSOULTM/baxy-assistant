...
OUT=ROOT/'artifacts/comprobaciones/C03/astra-constraint-purpose';OUT.mkdir(exist_ok=False)
...
prompt=('You write BAXY\'s brief acknowledgement of a user constraint. BAXY is a male companion on the user\'s PC. '
        ...
        'Return one short natural sentence in response_language, without JSON or explanation of these instructions.')
...
prereg={'cases':cases,'stages':['existing_composer','constraint_purpose'],'prompt':prompt,
