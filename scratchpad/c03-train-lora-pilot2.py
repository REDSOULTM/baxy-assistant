"""Two-epoch, 84-example development pilot using the measured QLoRA profile."""
...
OUT=ROOT/'artifacts/comprobaciones/C03/astra-lora-pilot2-training'
SAVE=Path('D:/BAXYRuntime/experiments/models/qwen3-4b-instruct-2507-training-cdbee75f/c03-pilot-lora-v2')
BASE=SAVE.parent
DATA=ROOT/'artifacts/comprobaciones/C03/astra-lora-pilot2-data'
