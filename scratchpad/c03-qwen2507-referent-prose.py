...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen2507-referent-prose'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen2507-referent-prose.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen2507-referent-prose/profile/sitecustomize.py',
         'scratchpad/c03-qwen2507-referent-prose.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'Remove only the lexical requirement for a generic action/task/do word from an otherwise valid missing-referent question. It rejected natural questions naming cerrar/close/open, despite valid JSON and no effect authority. Same six turns and profile as shared-clarification.',
          'expected': 'Six useful faithful replies; Spanish missing-reference question no longer fails solely for its wording. Both cancellations leave a usable normal next turn.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen2507-referent-prose'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen2507-referent-prose.turns.jsonl')]
