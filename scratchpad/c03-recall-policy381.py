...
out = root / 'artifacts/comprobaciones/C03/astra-recall-policy381'
private = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-recall-policy381-private'
...
try:
    ...
    configure = {'id': 'catalog381', 'type': 'catalog.configure', 'capabilities': capabilities}
