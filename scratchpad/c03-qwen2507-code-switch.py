...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen2507-code-switch'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen2507-code-switch.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen2507-code-switch/profile/sitecustomize.py',
         'scratchpad/c03-qwen2507-code-switch.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'One continuous answer with an explicit clause-level code-switch instruction replaces the existing vague spanglish instruction. No JSON parts or extra classifier. Same 12 turns, native sampling, token budgets, factual and language guards. Diagnostic only; source clarification rewording has no ambiguous-action case in this panel.',
          'expected': '12 useful faithful replies, complementary ES/EN clauses without full translation or omission. No stale welcome. Reject this profile if it merely increases publications without semantic quality.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen2507-code-switch'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen2507-code-switch.turns.jsonl')]
