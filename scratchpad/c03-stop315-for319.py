...
private=Path(os.environ['LOCALAPPDATA'])/'BAXY/C03-ui315-private'
...
with urllib.request.urlopen('http://127.0.0.1:60333/slots',timeout=5) as response:
...
snapshot=private.parent/'C03-ui315-snapshot319'
...
out=root/'artifacts/comprobaciones/C03/astra-native-history318'
(out/'STOP315.json').write_text(json.dumps({'snapshot':str(snapshot),'owned':owned},indent=2)+'\n',encoding='utf-8')
print('UI315 had no owner turns; logs preserved; verified owned tree stopped for integrated319.')
