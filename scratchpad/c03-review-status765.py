"""Correlate frozen765 outputs; no verdict inferred from terminal status."""
...
public = root / 'artifacts/comprobaciones/C03/STATUS_BATCH765'
truncated = []
...
if not args.partial:
    ...
    markdown = ['# Respuestas privadas765 — pendientes de adjudicación',
