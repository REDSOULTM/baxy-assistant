...
out=base/'astra-audio-mind486';private=local/'C03-audio-mind486-private'
...
try:
 ...
 config_req={'id':'catalog486','type':'catalog.configure','capabilities':capabilities}
 ...
 stop.set();client.close(graceful_message={'id':'close486','type':'shutdown'},timeout=15);guard.join(timeout=5);gpu.stop();ram.stop()
