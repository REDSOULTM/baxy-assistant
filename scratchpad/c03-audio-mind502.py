...
out=base/'astra-audio-mind502';private=local/'C03-audio-mind502-private'
...
try:
 ...
 config_req={'id':'catalog502','type':'catalog.configure','capabilities':capabilities}
 ...
 stop.set();client.close(graceful_message={'id':'close502','type':'shutdown'},timeout=15);guard.join(timeout=5);gpu.stop();ram.stop()
