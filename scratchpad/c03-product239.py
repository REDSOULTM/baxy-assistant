...
OUT = BASE / "astra-product239"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-product239-private"
...
assert read(BASE / "astra-dsp238/COMPLETE.json")["outputs"] == 10
inputs = read(BASE / "astra-dsp238/RESULTS.json")
