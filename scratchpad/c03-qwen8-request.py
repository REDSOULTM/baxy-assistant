...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen8-request'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen8-request.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen8-request/profile/sitecustomize.py',
         'scratchpad/c03-qwen8-request.py']
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen8-request'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen8-request.turns.jsonl')]
