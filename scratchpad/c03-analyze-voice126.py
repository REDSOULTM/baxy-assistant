...
out = root / "artifacts/comprobaciones/C03/astra-analysis126"
out.mkdir(exist_ok=False)
(out / "PREREG.json").write_text(json.dumps({
    "purpose": "Offline content and alignment comparison of existing physical123/125 captures",
    "sources": [123, 125], "newPlayback": False, "sourceMutation": False,
...
for number in [123, 125]:
    ...
    rows = []
    for phase in ["off-before", "direct", "off-after"]:
    ...
    target = private / "analysis126.json"
