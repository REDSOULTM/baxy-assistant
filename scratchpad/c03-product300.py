...
out = root/'artifacts/comprobaciones/C03/astra-memory-product300'
private = Path(os.environ['LOCALAPPDATA'])/'BAXY/C03-memory-product300-private'
...
command=['py','main.py','--conductor','--profile',str(private/'profile'),
