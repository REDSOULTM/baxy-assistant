...
out = base / 'astra-progress-role90'
...
prereg = {'method': 'Native two orthogonal contrasts against recorded88. Same six cases and factual state. '
...
try:
    ...
    for case in cases:
        for variant in ('dedicated_role', 'structured_request'):
            payload = copy.deepcopy(case['payload'])
            if variant in ('dedicated_role', 'structured_request'):
