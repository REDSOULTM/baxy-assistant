...
OUT = ROOT / "artifacts/comprobaciones/C03/astra-replay233"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-replay233-private"
...
save(OUT / "PREREG.json", {
    ...
    "hypothesis": "Reproduce both physical232 interruptions and actual queued segments on unchanged source230, before changing any acoustic algorithm. Compare VAD, actual guard and speaking timeline against232; no threshold or decoder change.",
...
np.savez(PRIVATE / "segments233.npz", **signals)
