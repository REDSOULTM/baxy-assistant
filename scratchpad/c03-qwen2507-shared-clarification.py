...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen2507-shared-clarification'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen2507-shared-clarification.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen2507-shared-clarification/profile/sitecustomize.py',
         'scratchpad/c03-qwen2507-shared-clarification.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'Reuse shared closed request reading for absent referents and the existing question language/style helper for domain confirmation. Missing-reference prompt preserves an action already named. Same six turns as clarification-wording; ordinary sampling profile with no mixed experiments.',
          'expected': 'Six useful faithful replies: missing-target clarification, cancellation and correct normal next turn in ES/EN, no effect when referent is absent.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen2507-shared-clarification'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen2507-shared-clarification.turns.jsonl')]
