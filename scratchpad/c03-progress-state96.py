...
out = base / 'astra-progress-state96'
...
prereg = {'method': 'State-authority scoping prototype after raw-request framing/profile failures. Exact87 factual '
