...
OUT = ROOT / 'artifacts/comprobaciones/C03/COMPOSE_BOUNDARY753'
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-compose753-private'
PROFILE = PRIVATE.parent / 'C03-compose-profile753'
...
observer_check = ROOT / 'scratchpad/c03-observer-preflight753.py'
check_spec = importlib.util.spec_from_file_location('observer_preflight753', observer_check)
check_module = importlib.util.module_from_spec(check_spec)
check_spec.loader.exec_module(check_module)
observer = ROOT / 'scratchpad/c03-compose753-hook/sitecustomize.py'
