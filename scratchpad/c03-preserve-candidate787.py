"""Preserve measured787 before any further repair; do not adopt it."""
...
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-inventory-source787-private'
...
assert head == '1e997b9c1f2312b13d69e7d8e242f9cde663c1c9'
patch = []
...
record = {'utc': datetime.now(timezone.utc).isoformat(), 'candidate_adopted': False,
          ...
          'reverse_patch_check_exit': 0, 'reason': '788 admits incomplete inventory5-2 after removal of false quantity veto; preserve measured candidate and repair coverage before adoption.'}
