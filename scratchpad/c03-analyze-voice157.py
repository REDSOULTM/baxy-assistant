...
out = root / "artifacts/comprobaciones/C03/astra-analysis157"
out.mkdir(exist_ok=False)
(out / "PREREG.json").write_text(json.dumps({
    "purpose": "Offline content around the observed interruption148: compare microphone and loopback; no assumption of its cause",
    "sources": [148], "newPlayback": False, "sourceMutation": False,
...
for number in [148]:
    ...
    target = private / "analysis157.json"
