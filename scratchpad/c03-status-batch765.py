...
OUT = ROOT / 'artifacts/comprobaciones/C03/STATUS_BATCH765'
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-status-batch765-private'
PROFILE = PRIVATE.parent / 'C03-status-profile765'
...
prereg = {
    'utc': utc(), 'method': 'Registered73 product regression after dense inventory764; same panel and criteria as761/752B, no model comparison.',
    ...
    'validation': 'Published764 owners136pass and Fast; Python760 intact. Full7 historical, not new product acceptance.',
    'source760_pins': pins760, 'source764_pins': pins764, 'sources': sources, 'runner_sha256': sha(__file__),
