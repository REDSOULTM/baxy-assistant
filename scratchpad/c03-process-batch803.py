...
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-process-batch803-private'
PROFILE = PRIVATE.parent / 'C03-process-profile803'
...
prereg = {
    'utc': utc(), 'method': 'Registered50 process-read category with sealed candidate802; nine historical requests and41 variants. Build prepared before sealing DLL; model selection is closed.',
