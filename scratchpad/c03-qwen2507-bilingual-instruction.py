...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen2507-bilingual-instruction'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen2507-bilingual-instruction.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen2507-bilingual-instruction/profile/sitecustomize.py',
         'scratchpad/c03-qwen2507-bilingual-instruction.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'Use a bilingual instruction that demonstrates ordinary switching, without demanding a full clause in each language. Source includes independently tested clock-unit equivalence and language-wrapper repair. This is the last wording diagnostic; not isolated attribution for those source repairs.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen2507-bilingual-instruction'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen2507-bilingual-instruction.turns.jsonl')]
