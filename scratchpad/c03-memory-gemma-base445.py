...
assert len(cases)==11
out=base/'astra-memory-gemma-base445';private=local/'C03-memory-gemma-base445-private'
...
model=Path('D:/BAXYRuntime/experiments/models/gemma4-e2b-inherited-d3b0fed4/base-gguf/gemma-4-E2B-it-Q4_K_M.gguf')
def sha(p):
...
assert prereg['model_sha256']=='740185b21d22ceb83a11c3aa62ad5842ef32c70f6096d756bbee85a1e4ec34b8'
