...
out=base/'astra-context-retrieval489';private=local/'C03-context-retrieval489-private'
...
try:
 ...
 config_req={'id':'catalog489','type':'catalog.configure','capabilities':capabilities}
 ...
 stop.set();client.close(graceful_message={'id':'close489','type':'shutdown'},timeout=15);guard.join(timeout=5);gpu.stop();ram.stop()
