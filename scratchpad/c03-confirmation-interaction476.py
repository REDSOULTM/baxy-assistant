...
out = base / 'astra-confirmation-interaction476'
private = local / 'C03-confirmation-interaction476-private'
...
write(out / 'PREREG.json', {
    ...
    'method': 'One interaction test, not a new prompt wording: combine exact task-duty replacement472 with exact native tool-role transfer474. Profile/fixtures/guards/source466 unchanged; first untransformed payload equals468; rendered protocol retained. 472 recovered some missing consequences but had voice defects;474 recovered activation/target but omitted consequences. Compared to474 only duty472 is changed. Same14compositions at seeds0/17. No effects, callable tools, UI/voice/reserved cases.',
    'criteria': 'Same465 useful/faithful/natural criteria and intact controls. Inspect every draft/final. If incomplete, abandon these composition-factor combinations; do not iterate wording or fields to chase this panel. No source/runtime promotion for partial coverage.',
