...
out=base/'astra-audio-mind499';private=local/'C03-audio-mind499-private'
...
try:
 ...
 config_req={'id':'catalog499','type':'catalog.configure','capabilities':capabilities}
 ...
 stop.set();client.close(graceful_message={'id':'close499','type':'shutdown'},timeout=15);guard.join(timeout=5);gpu.stop();ram.stop()
