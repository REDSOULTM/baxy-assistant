...
SOURCE = EXP / "source"
OUT = ROOT / "artifacts/comprobaciones/C03/astra-native-trace215"
PRIVATE = Path(os.environ["LOCALAPPDATA"]) / "BAXY/C03-native-trace215-private"
...
decoder = before[owners[1]].decode()
