"""Preserve measured791 before any further repair; do not adopt it."""
...
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-inventory-source791-private'
...
assert head == '345fe1e5513b0893c87751ca645c3145e8ab9435'
patch = []
...
record = {'utc': datetime.now(timezone.utc).isoformat(), 'candidate_adopted': False,
          ...
          'reverse_patch_check_exit': 0, 'reason': '791 repairs two reproduced checker errors; preserve exact source before paired792 integration ablation. No adoption or model ranking.'}
