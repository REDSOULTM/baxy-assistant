...
out = base / 'astra-confirmation-duty472'
private = local / 'C03-confirmation-duty472-private'
...
write(out / 'PREREG.json', {
    ...
    'method': 'Source466 unchanged; current actual guarded composer with one replacement of confirmation task instruction. Existing task requires action/target/choices but never explanation of supplied cause/consequences; remedy task contract, not another format or sampler sweep. Same registered2507 exactGGUF/b10809 officialT.7/.8/k20/min0/neutral/seed0,17/1024; actual first payload per case must equal468 before this one replacement. Preserve all literal headings, data, guards, retries. Six prior confirmation fixtures and one memory control per seed =14compositions. No effects/UI/voice/fresh credit. Inherited367/368 transport and469 empty headings do not repair this missing instruction duty; no repeat of those variants. If no useful improvement stop this strategy; no followup wording sweep.',
    'criteria': 'Same465 rubric, no weakening: pending action/target/choices, supplied irreversibility, sensitive-data nature, export literal destination and possible redirection/sync. No invented completion/cause. Compare each seed separately to468. Controls exact. No model/profile/source promotion before response review and integrated regression.',
