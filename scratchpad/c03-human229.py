...
OUT = BASE / "astra-human229"
PRIVATE_ROOT = Path(os.environ["LOCALAPPDATA"]) / "BAXY"
PRIVATE = PRIVATE_ROOT / "C03-human229-private"
...
spec = importlib.util.spec_from_file_location("baxy_mind.voice_baseline229", baseline_path)
...
for row in inputs:
    ...
    variants = []
    for name, module in [("before225", baseline), ("after228", current)]:
