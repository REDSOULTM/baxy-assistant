"""Run sealed789 owners and Fast, preserving every terminal result."""
...
OUT = ROOT / 'artifacts/comprobaciones/C03/INVENTORY_IDENTITY789'
...
result = {'utc': datetime.now(timezone.utc).isoformat(), 'python_command': command,
          ...
          'new_controls': 89, 'candidate_adopted': False, 'full_new': False}
