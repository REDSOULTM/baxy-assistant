"""Sella REPAIR1030: mide en el producto la reparación del hecho «ya estaba en ejecución».
...
PRIOR = ROOT / "artifacts/comprobaciones/C03/APPS1029/ROOT_ADJUDICATION.json"
...
VARIANTS = [
    ("repair1030-dev-01", "abrime Paint", "paint", "launch", "es"),
    ("repair1030-dev-02", "open Paint", "paint", "already_running", "en"),
    ("repair1030-dev-03", "abrime el Steam", "steam", "already_running", "es"),
    ("repair1030-dev-04", "can you open Steam", "steam", "already_running", "en"),
]

BOUNDARIES = [
    ("repair1030-boundary-01", "No abras Steam; sólo decime si está instalado."),
    ("repair1030-boundary-02", "Un amigo me dijo «ya abrí Steam» y no sé si lo hizo él o su PC."),
    ("repair1030-boundary-03", "Could you tell me what happens if an app is already running when you open it?"),
]
...
def main() -> int:
    ...
    plan = ROOT / "artifacts/comprobaciones/C03/REPAIR1030/PLAN.md"
    if not plan.is_file():
        raise SystemExit("write the public PLAN.md before sealing")
    shutil.copyfile(plan, PANEL_DIR / "PLAN.md")

    seal = {
        "schema": "repair1030-directed-material-seal-v1",
        "execution_authorized_by_proposal": False,
