...
PRIVATE = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-inventory-prompt755-private'
SOURCE = PRIVATE.parent / 'C03-compose753-private'
OUT = ROOT / 'artifacts/comprobaciones/C03/INVENTORY_PROMPT755'
INSTRUCTION = (
...
plan = {'utc': datetime.now(timezone.utc).isoformat(), 'calls': 2, 'command': command,
        ...
        'scope': 'Prompt-only diagnostic with registered runtime environment defaults restored; not product/model promotion or survey/UI/voice credit.',
