...
out = ROOT / 'artifacts/comprobaciones/C03/astra-qwen2507-spoken-clock'
...
files = ['src/baxy_mind/llm.py', 'src/baxy_mind/__main__.py',
         ...
         'artifacts/comprobaciones/C03/astra-qwen2507-spoken-clock.turns.jsonl',
         'artifacts/comprobaciones/C03/astra-qwen2507-spoken-clock/profile/sitecustomize.py',
         'scratchpad/c03-qwen2507-spoken-clock.py']
manifest_hash = sha(manifest_path)
prereg = {'kind': 'integrated-development-diagnostic-not-promotion',
          'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(),
          'hypothesis': 'Previous real t1 produced Son las 10 y 10 for observed10:10, rejected repeatedly by numeric clock validator. Extend shared Python/shell equivalence to clock-framed Spanish hour y minute with AM/PM; preserve rejection of wrong times, contradictory second clocks, and unrelated item counts. Keep cancelled action facts.',
          'expected': 'Same21 development requests/profile and model as personal-shell and first21 cancel-action. Exact previous draft separately replayed through compose in regression; real replies must preserve clock facts, cancellation, personal reads and confirmation. No repeated fault injection, reserved acceptance or promotion.',
...
command = ['powershell.exe', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File',
           ...
           str(Path(env['LOCALAPPDATA'])/'BAXY/comprobaciones-c03-qwen2507-spoken-clock'),
           '-Capture', str(out), '-TurnsFile',
           str(ROOT/'artifacts/comprobaciones/C03/astra-qwen2507-spoken-clock.turns.jsonl')]
