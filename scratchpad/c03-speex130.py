...
out = root / 'artifacts/comprobaciones/C03/astra-speex130'
out.mkdir(exist_ok=False)
private = Path(os.environ['LOCALAPPDATA']) / 'BAXY/C03-speex130-private'
