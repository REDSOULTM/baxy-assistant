...
private=Path(os.environ['LOCALAPPDATA'])/'BAXY/C03-ui302-private'
...
snapshot=private.parent/'C03-ui302-snapshot308'
...
out=root/'artifacts/comprobaciones/C03/astra-request-speaker307'
(out/'STOP302.json').write_text(json.dumps({'snapshot':str(snapshot),'owned':owned},indent=2)+'\n',encoding='utf-8')
print('UI302 had no owner turns; logs preserved; verified owned tree stopped for integrated308.')
