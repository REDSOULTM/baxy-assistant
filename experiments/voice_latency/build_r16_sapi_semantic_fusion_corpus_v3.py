"""Build R16 ASR fusion with conservative exhaustive-clause union."""
...
CORPUS_SCHEMA = "baxy.r16-sapi-semantic-asr-fusion-development.v3"
REPORT_SCHEMA = "baxy.r16-sapi-semantic-asr-fusion-build-development.v3"
...
def main() -> int:
    ...
    report = builder.build(
        ...
        scope="opened_r16_authenticated_catalog_clause_union_asr_fusion_build",
        supersedes={
            "artifact": "r16_sapi_semantic_asr_fusion_build_v2.v1.json",
            "reason": "v3_conservatively_unions_index_aligned_exhaustive_report_clauses",
        },
    )
