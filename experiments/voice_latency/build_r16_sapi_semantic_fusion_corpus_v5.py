"""Build R16 fusion after pause-safe VAD redecodes both ASR engines."""
...
CORPUS_SCHEMA = "baxy.r16-sapi-semantic-asr-fusion-development.v5"
REPORT_SCHEMA = "baxy.r16-sapi-semantic-asr-fusion-build-development.v5"
...
def main() -> int:
    ...
    report = builder.build(
        ...
        scope="opened_r16_pause_safe_dual_redecode_authenticated_catalog_asr_fusion_build",
        supersedes={
            "artifact": "r16_sapi_semantic_asr_fusion_build_v4.v1.json",
            "reason": "v5_redecodes_both_asrs_and_requires_terminal_status_consensus",
        },
    )
