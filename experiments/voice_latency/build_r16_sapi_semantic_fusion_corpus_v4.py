"""Build R16 fusion over the pause-safe VAD Parakeet candidate."""
...
CORPUS_SCHEMA = "baxy.r16-sapi-semantic-asr-fusion-development.v4"
REPORT_SCHEMA = "baxy.r16-sapi-semantic-asr-fusion-build-development.v4"
...
def main() -> int:
    ...
    report = builder.build(
        ...
        scope="opened_r16_pause_safe_vad_authenticated_catalog_asr_fusion_build",
        supersedes={
            "artifact": "r16_sapi_semantic_asr_fusion_build_v3.v1.json",
            "reason": "v4_adds_pause_safe_vad_candidate_with_fixed_decode_tail",
        },
    )
