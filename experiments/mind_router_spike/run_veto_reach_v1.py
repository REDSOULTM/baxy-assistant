"""Open the sealed veto-reach population V1 exactly once."""
...
from experiments.mind_router_spike import build_veto_reach_v1 as campaign  # noqa: E402
...
def verify_preregistration() -> None:
    ...
    if (
        ...
        raise RuntimeError("veto-reach V1 preregistration changed")
    if campaign.OUTPUT.exists():
        raise RuntimeError("veto-reach V1 has already been opened")
...
def main() -> int:
    ...
    report = {
        "schema": "baxy.veto-reach-result.v1",
