"""Replay the opened R24 Mind surface after the gratitude-closure fix."""
...
probe.OUTPUT = REPO / "artifacts/development/catalog_surface_r24_postfix.v1.json"
probe.AUDIT = (
    REPO / "artifacts/development/catalog_surface_r24_postfix.v1.raw.jsonl"
)
