"""Open the preregistered current-tree catalogue surface exactly once."""
...
def configure() -> None:
    ...
    runner.CAMPAIGN = "current-tree-r1-catalog-surface"
    runner.RESULT_SCHEMA = "baxy.catalog-surface-current-tree-r1-mind-result.v1"
    runner.RESULT_SCOPE = "blind_current_tree_r1_all_catalogue_mind_surface"
