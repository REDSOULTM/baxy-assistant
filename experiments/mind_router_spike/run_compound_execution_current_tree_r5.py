"""Open the sealed current-tree Cut-C campaign R5 exactly once."""
...
def verify_preregistration() -> None:
    ...
    if (
        ...
        raise RuntimeError("current-tree compound R5 preregistration changed")
    if campaign.OUTPUT.exists():
        raise RuntimeError("current-tree compound R5 has already been opened")
