"""Open the preregistered R22 Mind-owned catalogue surface exactly once."""
...
def configure() -> None:
    ...
    runner.BUILDER = REPO / "scripts/build_catalog_surface_holdout_r22.py"
    runner.CAMPAIGN = "r22-catalog-surface"
    runner.RESULT_SCHEMA = "baxy.catalog-surface-holdout-r22-mind-result.v1"
    runner.RESULT_SCOPE = "blind_r22_all_catalogue_mind_surface"
