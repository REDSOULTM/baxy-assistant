"""Open the preregistered R26 Mind catalogue surface exactly once."""
...
def configure() -> None:
    ...
    runner.BUILDER = REPO / "scripts/build_catalog_surface_holdout_r26.py"
    runner.CAMPAIGN = "r26-catalog-surface"
    runner.RESULT_SCHEMA = "baxy.catalog-surface-holdout-r26-mind-result.v1"
    runner.RESULT_SCOPE = "blind_r26_all_catalogue_mind_surface"
