"""Open the preregistered R25 Mind catalogue surface exactly once."""
...
def configure() -> None:
    ...
    runner.BUILDER = REPO / "scripts/build_catalog_surface_holdout_r25.py"
    runner.CAMPAIGN = "r25-catalog-surface"
    runner.RESULT_SCHEMA = "baxy.catalog-surface-holdout-r25-mind-result.v1"
    runner.RESULT_SCOPE = "blind_r25_all_catalogue_mind_surface"
