"""Open the sealed veto-reach population V5 exactly once."""
...
from experiments.mind_router_spike import build_veto_reach_v5 as campaign  # noqa: E402
...
def verify_preregistration() -> None:
    ...
    if (
        ...
        raise RuntimeError("veto-reach V5 preregistration changed")
    if campaign.OUTPUT.exists():
        raise RuntimeError("veto-reach V5 has already been opened")
...
def main() -> int:
    ...
    report = {
        "schema": "baxy.veto-reach-result.v5",
