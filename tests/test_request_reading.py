...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("De nada, amigo. How ya doing today?", "es", True),
        ("You're welcome. ¿Cómo estás hoy?", "en", True),
        ("Buenas tardes. The file is open.", "es", True),
        ("La app dice: «Hello. How are you?». Está abierta.", "es", False),
        ('El texto es "Welcome. You are ready.". Es una cita.', "es", False),
        ("La ventana se llama Hello World. Está abierta.", "es", False),
        ("Your name is Álvaro. You're welcome.", "en", False),
        ("De nada. How are you?", "mixed", False),
        ('"The file is open."', "es", True),
        ("Este es el ejemplo:\n```python\nif x is None:\n    return None\n```", "es", False),
        ("Usa `The file is open. You can continue.` como texto literal.", "es", False),
        ("La frase es 'Hello. How are you?'. Es una cita.", "es", False),
        ("Buenas tardes. I don't know. We can't open it.", "es", True),
    ],
)
