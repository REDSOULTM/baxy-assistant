...
def test_map_cannot_expand_baxy_capabilities() -> None:
    ...
    # 190 -> 203: las trece herramientas tipadas de la auditoría semántica REOPEN1957/1993.
    # 203 -> 204: audio.app.volume.set (Fase 8, D18).
    assert len(public_operations) == 204
