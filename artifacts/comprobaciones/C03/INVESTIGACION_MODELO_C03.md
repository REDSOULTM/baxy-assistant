...
## 593–606: idioma, representación y frontera de inferencia

593 confirma dos causas separadas: el guard declara incomplete_effect paraH0012 y su proyección sustituye conocimiento por unsupported; las dos preguntas inglesas sí llegan como conocimiento/en, pero repiten una respuesta española.594/595 no pasan sus controles de negación/completitud/cuenta: no se adoptan ni se siguen barriendo instrucciones.596 tomó payloads antes de la unión system de _post; se conserva como reproducción incompleta.597 reproduce el envío efectivo y mantiene los fallos.
