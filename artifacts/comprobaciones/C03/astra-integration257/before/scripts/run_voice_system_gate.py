...
from baxy_mind.dtln_aec import EchoCanceller, FRAME_SAMPLES, REFERENCE_SAMPLES  # noqa: E402
...
EXPECTED_DISTRIBUTIONS = {
    ...
    "ai-edge-litert": ("2.2.0", "Apache-2.0"),
...
def main() -> int:
    ...
    report = {
        ...
        "architecture": {
            ...
            "aec": "DTLN512 streaming capture AEC (CPU)",
