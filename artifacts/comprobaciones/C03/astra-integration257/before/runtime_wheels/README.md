...
## Cancelación de eco: candidata preparada en C03, todavía fuera del lock
...
El producto todavía usa DTLN hasta completar la integración y sus pruebas.
...
el consumidor instalará el binario fijado mediante el lock al adoptar la integración.
...
Eso acredita el paquete, no la aceptación de voz ni el cierre de C03. Los cambios
pendientes en captura, dependencias e instalación deben conservar esa equivalencia.
