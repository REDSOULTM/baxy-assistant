...
from .dtln_aec import EchoCanceller, REFERENCE_SAMPLES, resolve_echo_canceller_directory
    ...
    def probe(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "aec": bool(
                ...
                and _module_available("ai_edge_litert")
                and resolve_echo_canceller_directory()
            ),
                ...
                while not event.is_set() and self._session_is_current(session_epoch):
                    ...
                    if speech and self.speaking:
                        ...
                        if echo:
                            ...
                            # Low energy cannot open a turn during output, but
                            # quieter words must not split an admitted utterance.
                            speech = speech_started
                            barge_frames = 0
                    else:
                        barge_frames = 0

                    if barge_pending and speech and (
                        barge_frames >= 3 or not self.speaking
                    ):
                        barge_pending = False
                        admit_utterance(tuple(utterance))
                    ...
                    if speech and can_segment:
                        if not speech_started:
                            ...
                            if origin == "endpoint_wake_candidate":
                                ...
                                pending = self.speaking and barge_frames < 3
                                begin_utterance(
