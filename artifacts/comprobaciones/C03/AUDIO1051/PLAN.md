...
## Corrección de instrumentación tras preflight fallido

Core.WindowsPrivateStorage.PreparePrivateDataRoot exige un perfil hijo DIRECTO de LOCALAPPDATA/BAXY. El perfil anidado anterior fue un error de esta instrumentación, no del producto: root observó exit64 antes de hello, sin operaciones. Las versiones previas de sello/runner/adapter/plan se preservan en superseded-preflight; root conserva y renombra el pre/REPORT.json fallido. No se altera ningún texto, criterio, caso ni snapshot.

Perfiles runtime corregidos: runner usa LOCALAPPDATA/BAXY/C03-audio1051-profile; adaptador pre usa C03-audio1051-pre-profile y post usa C03-audio1051-post-profile bajo el mismo padre. Se conserva la guarda original direct-child y el adaptador rechaza reutilizar un perfil existente. Los archivos que edita esta propuesta y los recibos pre/post permanecen dentro de proposal; esta restricción no obliga a anidar perfiles de ejecución. No se borró ni renombró ningún recibo de root; no se ejecutó Core durante la corrección.
