...
Instrucción nueva del dueño: «no hagas test, saca el goal lo mas rápido posible, sin perder calidad». No se lanzan suites ni Full. Está pendiente una única aclaración sobre si también excluye paneles de producto; mientras tanto se avanza con revisión e implementación, sin nuevas ejecuciones.871 incorpora el ajuste mínimo de un alias de Configuración ya reconocido, sin tests y sin atribuirle crédito.
