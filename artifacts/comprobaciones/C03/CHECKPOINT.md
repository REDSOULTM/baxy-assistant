...
Instrucción nueva del dueño: «no hagas test, saca el goal lo mas rápido posible, sin perder calidad». No se lanzan suites ni Full. Está pendiente una única aclaración sobre si también excluye paneles de producto; mientras tanto se avanza con revisión e implementación, sin nuevas ejecuciones.871 incorporó el alias de Configuración.872 corrige la selección de Google y conserva la consulta;875 admite artículos indefinidos al resolver nombres de apps. Revisión manual, sin tests ni crédito por estos cambios.
