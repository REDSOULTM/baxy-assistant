...
| Cambiar **voz / wake / STT / TTS** | `src/baxy_mind/voice.py`; AEC en `speex_aec.py`, captura en `voice_capture.py`, loopback/ducking en `voice_aec.py`, salida en `voice_output.py`/`piper_tts.py`; `scripts/setup_mind_voice.ps1` | `documentacion/01_ARQUITECTURA/GUIA_AGENTES_IA/07_LATENCIA_END_TO_END.md` |
