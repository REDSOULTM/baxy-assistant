"""Bounded RAW WASAPI microphone capture with a native ADC clock."""
...
class WasapiCaptureStream:
    ...
    def __enter__(self) -> WasapiCaptureStream:
        ...
        with ExitStack() as resources:
            ...
            # sounddevice 0.5.5 exposes this PortAudio field only through CFFI.
            # RAW avoids Windows adaptive AEC/NS before our referenced Speex AEC.
            settings._streaminfo.streamOption = sd._lib.eStreamOptionRaw  # noqa: SLF001
