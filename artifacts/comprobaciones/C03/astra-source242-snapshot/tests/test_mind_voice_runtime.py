...
def test_capture_owns_aec_and_closes_it_after_success_or_failure(monkeypatch, failure):
    ...
    monkeypatch.setattr(voice_module, "resolve_echo_canceller_directory", lambda: Path("fixture-models"))
    ...
    class Canceller:
        ...
        def process(mic, reference):
            return mic * 3, mic * 32768, reference
