...
## cien-76 a cien-94 (leídas, v18, Qwen3-4B registrado, 2026-09-20/21)
...
| cien-93 | **100** | **0** | **100** | árbol b7ce28d42: la búsqueda admite el clítico y recorta la cortesía, su informe nombra el sitio, web.search queda a la vista del decisor para una búsqueda pública reconocida, el vocabulario propio del informe no es afirmación sin fuente y la pista del veto nombra las palabras. Leída contra cien-92: 19 líneas distintas, 14 relojes (06:2x → 09:2x) y cinco reformulaciones con los mismos hechos («What specifically…», la caché, «un compañero», el kernel). Ningún turno de la población es una búsqueda web. Captura `cien-93/events.jsonl` `d94e70d13480ef3109bd876f1a61b058e237340bdd3562b8ecd782f5c3e8918b` |
...
| cien-98 | **100** | **0** | **100** | árbol cf0f4ef6 (notebook, cierre del wall, 2026-09-22; Full verde): las tandas del notebook y sus reparaciones (nombres observados de archivos, carpetas y textos leídos como vocabulario; finales de misión de imagen; productor de file.open; salida de consola entera; lector de winget; desinstalar sin Inicio ambiguo) y la línea de composición fallida sin prosa de la App. Leída contra cien-97: 19 líneas distintas, 8 relojes (00:3x → 19:3x), el volumen leído de verdad en ese momento (22: lo dejaron las pruebas de audio del Full; restaurado a 70 después) y reformulaciones con los mismos hechos («Sure, what’s on your mind?» por «Got it, no apps opened», la explicación de la caché y del kernel con otras palabras); ningún turno pregunta donde antes contestaba ni al revés; 0 operaciones. Captura `cien-98/events.jsonl`: cruda `2218113533a7b3f66320d7d9183f7e60895aafe279e9dc6955dec8e66b62eeda`, en el repositorio (normalizada a LF) `543b8b282b851c2b5669a0883e1dda7dc08b4105b2bec722f116e3a23b983111` |
| cien-99 | 100 | 0 | 97 | árbol c47377c6 (Fase 3.5, semantic S7: dominios en `semantic/`, puerta `read()`, hueco de diálogo, charla, compuestas). **No limpia**: 074 «y por qué importa al abrir programas» — la explicación «la memoria caché …» fue vetada porque la regla de pretérito por forma leyó «caché» como primera persona (S1), dos intentos, recuperación y el hecho nuevo de `request_analysis_failed` casi literal («No se realizó ninguna acción…»); 097 «don't open the calculator» tras «¿Qué quieres que abra?» — el hueco la tomó como respuesta, re-armada y contestada en castellano; 049 «hazlo» tras «haz eso» → repitió «¿Qué es eso?». Arreglados después (sustantivos en é/í fuera del pretérito, hecho natural, una prohibición y el asentimiento a un pedido vacío no llenan el hueco). El resto, leído contra cien-98: 22 líneas distintas, relojes (19:3x → 14:2x), el volumen leído de verdad (22 → 70) y reformulaciones con los mismos hechos; 0 operaciones. Captura `cien-99/events.jsonl`: cruda `8f44ae1bda534410a350d62ec1881731cdcd026d6fdd1e5d81486d37530c22fb`, normalizada a LF `c33a40ed319a76b4fb236bd05a3f80b6e68422cff89e80d78068aef368ba0a2a` |
| cien-100 | **100** | **0** | **100** | árbol 342f1176 (Fase 3.5, semantic S8; Full verde): la lectura de la cien-99 arreglada (sustantivos en é/í fuera del pretérito, prohibición y asentimiento a un pedido vacío fuera del hueco, hecho natural de `request_analysis_failed`). Leída contra cien-98: 19 líneas distintas, relojes (19:3x → 15:2x), el volumen leído de verdad (22 → 70) y reformulaciones con los mismos hechos («un compañero» → «tu compañero», «Por favor», el pedido a Vesta con otras palabras); 049, 074 y 097 vuelven a la respuesta de cien-98; ningún turno pregunta donde antes contestaba ni al revés; 0 operaciones. Captura `cien-100/events.jsonl`: cruda `a4a32a46e0508d0e898e6047d341ac00cfcf19dfdb21ed4fa2828f7338ddf874`, normalizada a LF `8593a2e9ec045cfc2bee9d9cc0754837c30567610538c8d8291b17c7bc9e2435` |
| cien-101 | **100** | **0** | **100** | árbol 9277c10e (Fase 3.5, semantic S9: guardas de entrada a `semantic/guards.py`, traslado puro; Full verde). Leída contra cien-100: 17 líneas distintas, relojes (15:2x → 16:0x) y reformulaciones con los mismos hechos («para qué lo necesita el PC» nombra el kernel, «Sure! What’s on your mind?» más corta, «por favor» en minúscula); ningún turno pregunta donde antes contestaba ni al revés; 0 operaciones. Captura `cien-101/events.jsonl`: cruda `c8b0035bedb481d5748dac136da6599c809699b8983a9aa401c2691e6b78a394`, normalizada a LF `a875259a6be78da11ead0da93423e43fc2496cb552cf5f9fad43f1efc4829f86` |
