...
La reparación candidata de OCR pasó el Full: 12.907 pruebas Python aprobadas, tres omisiones y 466 subpruebas; 4.715 pruebas .NET aprobadas y una omisión agregada. Se conserva también el Full anterior interrumpido. Una captura real pasó 16 comprobaciones de identidad y archivo, pero mostró un recorte que requiere revisar la escala de coordenadas de Windows. Ese límite queda abierto. Las ocho consultas con la imagen sintética están listas para comprobar el compositor; no acreditarán memoria de aplicaciones reales.
