...
BAXY permanece cerrado para uso manual. Main, la encuesta original y los cambios del dueño se conservan. La captura corregida está publicada en Goal-c03,80f57efe; la reparación OCR ya pasó la validación completa. El siguiente límite observado es el fallo al enfocar la ventana; se conserva como fallo real sin inventar una causa. [Captura](OBSERVATION837/ROOT_REVIEW.md), [OCR con BAXY](OCR_COMPOSER832/REPORT.md), [último control](OCR_NATIVE838/REPORT.md), [procesos49/50](PROCESS_BATCH824/REPORT.md).
