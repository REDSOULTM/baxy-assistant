...
internal sealed class MainWindowViewModel : INotifyPropertyChanged, IAsyncDisposable
{
        ...
        string? pendingClarificationObjective = null)
    {
        ...
        MindTurnDecision? turn = await mind.DecideTurnAsync(
            ...
            cancellationToken,
            // This first classification is deliberately isolated from the
            // pending objective. Marking it pending while sending no history
            // disabled the mind's standalone-request reading. A slot fragment
            // still resumes below through MindClarificationPolicy.
