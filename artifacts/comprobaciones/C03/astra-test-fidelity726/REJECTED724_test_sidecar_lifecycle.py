...
"""
    ...
    try:
        ...
        if process.stdin is not None:
            process.stdin.close()
        greeting_reader.join(timeout=3.0)
    ...
    assert b'"type":"hello"' in greeting + stdout
