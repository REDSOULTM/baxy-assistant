...
widget:
- source_sentence: take a screenshot
  sentences:
...
- source_sentence: salva la presentazione
  sentences:
  - 'operar dentro de una app ya abierta: clickear o entrar a un boton, canal, servidor,
    pestania, seccion, contacto o elemento por su nombre. Windows UI Automation: find
    and click named controls inside an open app.'
  - list windows, focus, close, minimize, maximize, move, resize
  - create PowerPoint, Word, Excel documents
- source_sentence: Por favor, dame mis tarjetas de estudio
  sentences:
...
- source_sentence: Vérifie cette allégation immédiatement
  sentences:
  ...
  - describe what is on screen, READ ALOUD what a message or chat or notification
    ...
    mensaje, qué dice en la pantalla, qué me escribió, qué dice ese mensaje; OCR a
    region, find UI element
- source_sentence: what is a processor
  sentences:
...
* Size: 12,715 training samples
* Columns: <code>sentence_0</code> and <code>sentence_1</code>
* Approximate statistics based on the first 1000 samples:
  |         | sentence_0                                                                       | sentence_1                                                                         |
  |:--------|:---------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------|
  | type    | string                                                                           | string                                                                             |
  | details | <ul><li>min: 3 tokens</li><li>mean: 9.92 tokens</li><li>max: 44 tokens</li></ul> | <ul><li>min: 8 tokens</li><li>mean: 56.47 tokens</li><li>max: 128 tokens</li></ul> |
* Samples:
  | sentence_0                                       | sentence_1                                                                                                                                                                                                                                                     |
  |:-------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | <code>mandale un mensaje entonces</code>         | <code>WhatsApp messaging: send a message, REPLY/answer a message, open a chat, mandar/responder/contestar un mensaje por WhatsApp, respondele/contestale a una persona, escribir a alguien en wsp, decirle algo a alguien en whatsapp, mensaje de texto</code> |
  | <code>sì</code>                                  | <code>Steam game library, Steam store, launch installed Steam games</code>                                                                                                                                                                                     |
  | <code>quiero usar la app NoExisteNunca999</code> | <code>abrir, cerrar o encontrar un programa o juego ya instalado en esta computadora, desde el menú de inicio; open, close or find an installed desktop application on this PC by name</code>                                                                  |
