...
widget:
- source_sentence: abre youtube y pon un video
  sentences:
...
- source_sentence: buenas, phrase_hook_test_1778868234 y dime la hora
  sentences:
...
- source_sentence: Busca toreo en google
  sentences:
...
- source_sentence: que dispositivo de audio tengo activo
  sentences:
...
- source_sentence: cerrá Discord
  sentences:
  - start and track long-running background subprocess jobs
