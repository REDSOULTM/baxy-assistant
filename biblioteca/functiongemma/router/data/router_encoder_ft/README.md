...
widget:
- source_sentence: cierra Spotify
  sentences:
...
- source_sentence: Restaura a janela do Word
  sentences:
  ...
  - list windows, focus, close, minimize, maximize, move, resize
- source_sentence: Di en el grupo de wsp de intelectra que la tarde esta lentisima
  sentences:
...
- source_sentence: unmute it
  ...
  - audio volume, raise or lower the sound volume, turn it up or down (subir/bajar
    ...
    ton an, couper/rétablir le son, silenciar/reativar o som), system sound, media
    keys, audio devices listing
- source_sentence: podrias abrir spotify y buscar a bad bunny
  sentences:
...
* Approximate statistics based on the first 1000 samples:
  ...
  |:--------|:---------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------|
  | type    | string                                                                           | string                                                                             |
  | details | <ul><li>min: 3 tokens</li><li>mean: 9.63 tokens</li><li>max: 73 tokens</li></ul> | <ul><li>min: 8 tokens</li><li>mean: 71.88 tokens</li><li>max: 128 tokens</li></ul> |
* Samples:
  | sentence_0                                      | sentence_1                                                                |
  |:------------------------------------------------|:--------------------------------------------------------------------------|
  | <code>Verschieb Steam in die untere Ecke</code> | <code>list windows, focus, close, minimize, maximize, move, resize</code> |
  | <code>safety aprova</code>                      | <code>confirm pending risky actions</code>                                |
  | <code>Mets Notepad en plein écran</code>        | <code>list windows, focus, close, minimize, maximize, move, resize</code> |
