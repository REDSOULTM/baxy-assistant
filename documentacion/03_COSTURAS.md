...
| **Reconocedor determinista** | Contrato | Sobre el mismo corpus fresco, **tres números juntos**: cuántas filas reclama, cuántas acierta, y cuántas peticiones fuera de catálogo reclama por error. La tercera es la que manda: un reconocedor que reclama algo que no sabe hacer produce un efecto no pedido | 12.310 líneas de reglas en `effect_intent.py`. Medido: reclama **30 de 124** filas dentro de catálogo y acierta **24** (80 %); no reclama **ninguna** de las 36 fuera de catálogo. Sus 6 errores son desvíos silenciosos a una hermana — «dejame el sonido a la mitad» resuelve `audio.status` en vez de `audio.volume`. Responde en **p50 0,007 s** | 03 | 2026-08-17 |
...
| **Puerta de alcance (abstención)** | Contrato | Dos números que se leen juntos y nunca uno solo: **cuántas propuestas legítimas conserva** y **cuántas peticiones fuera de catálogo rechaza**, sobre el corpus fresco. Un candidato que suba lo segundo bajando lo primero está comprando abstención con trabajo real, y se rechaza. El piso es conservar ≥ 99 % de lo que sí está en catálogo | La puerta léxica curada de `effect_intent.py`: conserva **54 de 82** propuestas legítimas y deja pasar **6 de 24** fuera de catálogo. Es cara —cuesta 27 respuestas correctas de 124— y **se queda porque no hay sustituto**: cinco medidos y cinco rechazados, incluido un clasificador supervisado sobre 23.661 filas etiquetadas contra este catálogo (AUC 0,98 en su distribución, **0,58 en paráfrasis libre**). La causa está localizada: 11 de 20 peticiones fuera de catálogo caen en operaciones de argumento libre, que ningún contrato puede negar | 03 | 2026-08-17 |
