...
| G03C.06 / 295 | Pico VRAM ≤ 4 GB durante un turno con el modelo cargado, medido. | C07 | PENDIENTE | — evidencia disponible — owner C07: astra-private-product521, pico GPU 3497,559 MiB (3,42 GiB), RAM 2013,480 MiB con runtime registrado; sin UI/voz, no acredita el pico conjunto de esos componentes. Reanudar C07 con medición conjunta. Evidencia conservada en 892c506. |
...
| G04.06 / 310 | **Publicado.** Candidato propio validado y publicado en la rama de trabajo fuera de main, con HEAD igual a su rama remota y sin cambios propios pendientes. El encargo `C03_ASTRA_AUTORIDAD.md` sustituye para C03 la obligación de integrar en main. | C03 | CUMPLIDO | Publicación de fuente validada comprobada: Fuente adoptada HEAD=origin/Goal-c03=1d08cc297547ebc1d38d98492a41973816423416 al publicar545; sin fuente propia pendiente después. Main intacto5f572ee. Incluye control892c506 y correcciones528–545. Dueñas545:3699 pass+121 subtests,0 skips; Fast verde, Release21,23s sin advertencias/errores; Full final y aceptación C03 siguen pendientes. No equivale al cierre de las demás filas. |
