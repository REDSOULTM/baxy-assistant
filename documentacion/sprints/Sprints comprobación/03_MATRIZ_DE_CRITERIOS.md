...
| G04.06 / 310 | **Publicado.** `git status --short` vacío y `git rev-list --count origin/main..main` en **0**: todo lo del goal está en `origin/main`. Un goal con el trabajo sólo en este PC no está cerrado, por verdes que estén los demás criterios. | C03 | PENDIENTE | WIP C03 2026-09-04 aún no en origin/main |
...
| ID / línea | Criterio original completo | Owner | Estado | Evidencia |
|---|---|---|---|---|
| G06.01 / 296 | Cien respuestas seguidas leídas a mano y ninguna suena a máquina rellenando un hueco. | C03 | PENDIENTE | [CIEN.md](../../../artifacts/comprobaciones/C03/CIEN.md) cien-16 leída: restates 004/009, Io→welcome 015, hueco 018, minimize 020. Policy posterior. No sello. |
...
| G06.06 / 304 | **Publicado.** `git status --short` vacío y `git rev-list --count origin/main..main` en **0**: todo lo del goal está en `origin/main`. Un goal con el trabajo sólo en este PC no está cerrado, por verdes que estén los demás criterios. | C03 | PENDIENTE | WIP C03 2026-09-04 aún no en origin/main |
