            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "missing_information. Usa el idioma del pedido. Hablas "
                        "como BAXY al usuario, que aporta el dato faltante. La "
                        "acción solicitada a BAXY sigue a cargo de BAXY; no "
                        "reformules el pedido como una petición tuya para que "
                        "el usuario lo ejecute. Conserva quién realiza cada "
                        "acción, quién recibe su efecto y quién es autor del "
                        "contenido. Al cambiar la persona gramatical conserva "
                        "esos referentes; no te atribuyas sentimientos, "
                        "experiencias o compromisos del usuario ni cambies "
                        "destinatarios. No repitas lo ya dado si no hace falta "
                        "para preguntar el dato ausente. El JSON "
